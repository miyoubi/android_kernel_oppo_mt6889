...
#define MT_GPUFREQ_CUST_INIT_OPP        (861000)
...
#define GPU_ACT_REF_FREQ                (861000)              /* KHz */
...
struct opp_table_info g_opp_table_segment_1[] = {
	GPUOP(861000, 77500, 77500, POSDIV_POWER_4, 1875), /* 0 sign off */
	GPUOP(854000, 76875, 76875, POSDIV_POWER_4, 1875), /* 1 */
	GPUOP(848000, 76250, 76250, POSDIV_POWER_4, 1875), /* 2 */
	GPUOP(842000, 75625, 75625, POSDIV_POWER_4, 1875), /* 3 */
	GPUOP(836000, 75000, 75000, POSDIV_POWER_4, 1875), /* 4 sign off */
	GPUOP(825000, 74375, 75000, POSDIV_POWER_4, 1875), /* 5 */
	GPUOP(815000, 73750, 75000, POSDIV_POWER_4, 1875), /* 6 */
	GPUOP(805000, 73125, 75000, POSDIV_POWER_4, 1875), /* 7 */
	GPUOP(795000, 72500, 75000, POSDIV_POWER_4, 1875), /* 8 */
	GPUOP(785000, 71875, 75000, POSDIV_POWER_4, 1875), /* 9 */
	GPUOP(775000, 71250, 75000, POSDIV_POWER_4, 1875), /*10 */
	GPUOP(765000, 70625, 75000, POSDIV_POWER_4, 1875), /*11 */
	GPUOP(755000, 70000, 75000, POSDIV_POWER_4, 1875), /*12 */
	GPUOP(745000, 69375, 75000, POSDIV_POWER_4, 1875), /*13 */
	GPUOP(735000, 68750, 75000, POSDIV_POWER_4, 1875), /*14 */
	GPUOP(725000, 68125, 75000, POSDIV_POWER_4, 1875), /*15 */
	GPUOP(715000, 67500, 75000, POSDIV_POWER_4, 1875), /*16 */
	GPUOP(705000, 66875, 75000, POSDIV_POWER_4, 1875), /*17 */
	GPUOP(695000, 66250, 75000, POSDIV_POWER_4, 1875), /*18 */
	GPUOP(685000, 65625, 75000, POSDIV_POWER_4, 1875), /*19 */
	GPUOP(675000, 65000, 75000, POSDIV_POWER_4, 1875), /*20 sign off */
	GPUOP(654000, 65000, 75000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(634000, 64375, 75000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(614000, 63750, 75000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(593000, 63125, 75000, POSDIV_POWER_4, 1250), /*24 */
	GPUOP(573000, 62500, 75000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(553000, 62500, 75000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(532000, 61875, 75000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(512000, 61250, 75000, POSDIV_POWER_4,  625), /*28 */
	GPUOP(492000, 60625, 75000, POSDIV_POWER_4,  625), /*29 */
	GPUOP(471000, 60000, 75000, POSDIV_POWER_4,  625), /*30 */
	GPUOP(451000, 60000, 75000, POSDIV_POWER_4,  625), /*31 */
	GPUOP(431000, 59375, 75000, POSDIV_POWER_4,  625), /*32 */
	GPUOP(410000, 58750, 75000, POSDIV_POWER_4,  625), /*33 */
	GPUOP(390000, 58125, 75000, POSDIV_POWER_4,  625), /*34 */
	GPUOP(370000, 57500, 75000, POSDIV_POWER_8,  625), /*35 */
	GPUOP(350000, 56875, 75000, POSDIV_POWER_8,  625), /*36 sign off */
};
...
struct opp_table_info g_opp_table_segment_2[] = {
	...
	GPUOP(675000, 65000, 75000, POSDIV_POWER_4, 1875), /*20 sign off */
	GPUOP(654000, 65000, 75000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(634000, 65000, 75000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(614000, 65000, 75000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(593000, 64375, 75000, POSDIV_POWER_4, 1250), /*24 */
	GPUOP(573000, 64375, 75000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(553000, 64375, 75000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(532000, 63750, 75000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(512000, 63750, 75000, POSDIV_POWER_4,  625), /*28 */
	GPUOP(492000, 63750, 75000, POSDIV_POWER_4,  625), /*29 */
	GPUOP(471000, 63125, 75000, POSDIV_POWER_4,  625), /*30 */
	GPUOP(451000, 63125, 75000, POSDIV_POWER_4,  625), /*31 */
	GPUOP(431000, 63125, 75000, POSDIV_POWER_4,  625), /*32 */
	GPUOP(410000, 62500, 75000, POSDIV_POWER_4,  625), /*33 */
	GPUOP(390000, 62500, 75000, POSDIV_POWER_4,  625), /*34 */
	GPUOP(370000, 62500, 75000, POSDIV_POWER_8,  625), /*35 */
	GPUOP(350000, 61875, 75000, POSDIV_POWER_8,  625), /*36 sign off */
};
